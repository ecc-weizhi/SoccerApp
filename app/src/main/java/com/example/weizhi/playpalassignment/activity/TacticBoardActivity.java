...
public class TacticBoardActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,
    TacticBoardFragment.OnListFragmentInteractionListener, PlayerFragment.OnListFragmentInteractionListener{
    private final String TA = TacticBoardActivity.class.getSimpleName();
